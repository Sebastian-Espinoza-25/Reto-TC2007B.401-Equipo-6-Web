...
const ProductForm = () => {
  ...
  return (
    <form className="product-form" onSubmit={handleSubmit} encType="multipart/form-data">
      ...
      <textarea name="description" placeholder="Descripción" value={formData.description} onChange={handleChange} required style={{ resize: 'none' }} />
      <div>
        <input type="number" name="dimensions_width" placeholder="Ancho (cm)" value={formData.dimensions_width} onChange={handleDimensionsChange} required />
        <input type="number" name="dimensions_height" placeholder="Alto (cm)" value={formData.dimensions_height} onChange={handleDimensionsChange} required />
      </div>
      ...
      <select name="category" value={formData.category} onChange={handleChange} required>
        ...
        <option value="Pantiprotectores Diarios">Pantiprotectores Diarios</option>
      </select>
